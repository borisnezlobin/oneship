...
const ErrorModal = ({ error }) => {
  ...
  const registerError = async () => {
    ...
    try {
      ...
      ua =
        Platform.OS + " " + Platform.Version + ", oneship: " + CONFIG.VERSION;
    }
    var report = {
      logs,
    ...
    try {
      ...
      log(
        "Sent error report, response status: " +
          response.status +
          ". Response body: " +
      ...
      >
        ...
        <PressableScale
          style={{
            ...
            height: 50,
            backgroundColor:
              errorReportStatus == "reported" ? CONFIG.green : CONFIG.darkGrey,
            borderRadius: 10,
            alignItems: "center",
            justifyContent: "center",
            marginTop: 36,
        ...
        >
          ...
          >
            {errorReportStatus == "unreported"
              ? "Report Error"
              : errorReportStatus == "reported"
                ? "Reported!"
                : "Just a sec..."}
          </Text>
        </PressableScale>
