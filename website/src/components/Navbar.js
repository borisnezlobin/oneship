...
const containerStyle =
  "h-12 fixed bottom-0 md:top-0 left-0 w-full bg-white flex" +
    ...
    <nav className={containerStyle}>
      {window.innerWidth >= 768 ? (
        <img
          src={logo}
          onClick={() => nav("/")}
          className="h-0 w-0 cursor-pointer md:h-36 md:w-36"
          alt="logo"
        />
      ) : (
        <></>
            ...
            >
              {userData ? (
                <>
                  <Link
                    to="/barcode"
                    className={calculateStyles("/barcode", path)}
                  >
                  ...
                  <Link
                    to="/settings"
                    className={calculateStyles("/settings", path)}
                  >
                ...
                <>
                  <Link
                    to="/register"
                    className={calculateStyles("/register", path)}
                  >
