      ...
      <div className='m-0 h-full flex flex-col justify-center items-center md:ml-64'>
        ...
        <button className='link' onClick={() => {
            toast(<>
                ...
                Copyright © 2023 Boris Nezlobin.<br />All Rights Reserved. <br /> For inquiries or permissions, please contact <a href="mailto:me@borisnezlobin.com" className='link'>Boris Nezlobin</a>.
                </p>
              </>, {
                style: {
                  borderRadius: '10px',
